...
const TRANSLATIONS = {
  de: {
    ...
    "guide.hurryUp": "Eine Minute noch! Beeil dich!",
    ...
    "flow.robot.title": "Sicherheitsprüfung",
    "flow.robot.body":
      "Bitte gib den folgenden Code ein, um fortzufahren. Groß-/Kleinschreibung beachten!",
    "flow.robot.ph": "Code eingeben…",
    "flow.robot.confirm": "Bestätigen",
    "flow.robot.notRobotLabel": "Ich bin kein Roboter.",
    "flow.robot.wrong": "Falscher Code. Bitte erneut versuchen.",
    ...
    "flow.guide.newtabPre": "Schnell — such ",
    "flow.guide.newtabPost":
      " im Verlauf unter der Leiste, bevor’s zwölf schlägt!",
    "flow.guide.robot": "Fast geschafft — gib den Code ein, um weiterzukommen.",
    "flow.guide.results":
  ...
  en: {
    ...
    "flow.robot.title": "Security check",
    "flow.robot.body":
      "Please enter the following code to continue. Case-sensitive!",
    "flow.robot.ph": "Enter code…",
    "flow.robot.confirm": "Confirm",
    "flow.robot.notRobotLabel": "I am not a robot.",
    "flow.robot.wrong": "Wrong code. Please try again.",
    "flow.robot.mustCheck": "Please confirm you are not a robot.",
    "flow.nav.jobs": "Jobs",
    ...
    "flow.guide.newtabPre": "Quick — look for ",
    "flow.guide.newtabPost":
      " in the history below the bar before it strikes twelve!",
    "flow.guide.robot": "Almost there — enter the code to continue.",
    "flow.guide.results":
